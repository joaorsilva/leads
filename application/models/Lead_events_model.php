...
/**
 * Description of Lead_event_types_model
 *
 ...
 */
class Lead_events_model extends CI_Model {
    
    protected $table_name = "lead_envents";
    
    public $id;
    public $lead_event_types_id;
    public $lead_leads_id;
    public $lead_messages_id;
    public $active;
    public $created_by;
    public $created_date;
    public $updated_by;
